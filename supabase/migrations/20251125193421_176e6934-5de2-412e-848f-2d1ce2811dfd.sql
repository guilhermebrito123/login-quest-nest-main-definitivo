-- Criar índice único para garantir que não haja dois agendamentos para o mesmo posto e data
CREATE UNIQUE INDEX IF NOT EXISTS ux_dias_trabalho_posto_data
ON public.dias_trabalho (posto_servico_id, data);

-- Função para agendar ocupação de posto
