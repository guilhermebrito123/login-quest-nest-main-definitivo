-- Atualizar função para manter posto_servico_id até a data de desvinculação
...
BEGIN
  ...
  IF NEW.data_desvinculacao IS NOT NULL AND NEW.posto_servico_id_origem IS NOT NULL THEN
    -- NÃO atualizar posto_servico_id aqui - será atualizado pela função processar_movimentacoes_agendadas na data de desvinculação
