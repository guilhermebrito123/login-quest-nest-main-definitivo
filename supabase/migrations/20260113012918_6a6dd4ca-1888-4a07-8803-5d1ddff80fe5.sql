...
-- 1. Update validar_diarias_temporarias_motivo_vago - remove references to licenca_nojo and colaborador_falecido
DROP FUNCTION IF EXISTS public.validar_diarias_temporarias_motivo_vago() CASCADE;

-- 2. Update log_diaria_temporaria_changes - remove licenca_nojo and colaborador_falecido audit
...
-- 3. Update validate_diarias_temporarias_required_fields - remove licenca_nojo and colaborador_falecido
...
-- 4. Update bloquear_edicao_diaria_temporaria - remove licenca_nojo and colaborador_falecido
...
-- Recreate the trigger for fn_audit_diarias_temporarias_granular
DROP TRIGGER IF EXISTS fn_audit_diarias_temporarias_granular ON public.diarias_temporarias;
CREATE TRIGGER fn_audit_diarias_temporarias_granular
